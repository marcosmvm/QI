    ...
    <div className="bg-light-bg-secondary dark:bg-midnight-blue border border-border-default dark:border-graphite rounded-xl">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-border-default dark:border-graphite">
        <div>
          ...
          <p className="text-sm text-slate-900 dark:text-slate-200">{campaigns.length} active</p>
        </div>
        <Link
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-border-default dark:border-graphite">
              <th className="px-4 py-4 text-left text-xs font-medium text-slate-900 dark:text-slate-200 uppercase tracking-wide">
                Campaign
              </th>
              <th className="px-4 py-4 text-left text-xs font-medium text-slate-900 dark:text-slate-200 uppercase tracking-wide">
                Status
              ...
              <th className="px-4 py-4 text-right text-xs font-medium text-slate-900 dark:text-slate-200 uppercase tracking-wide">
                Actions
              </th>
            </tr>
          </thead>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1">
                      {campaign.status === "active" ? (
                        <button className="p-1.5 text-slate-900 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white rounded transition-colors">
                      ...
                      <Link
                        href={`/dashboard/campaigns/${campaign.id}`}
                        className="p-1.5 text-slate-900 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white rounded transition-colors"
                      >
                        <Eye className="h-4 w-4" />
                      </Link>
                      <button className="p-1.5 text-slate-900 dark:text-slate-200 hover:text-alert-red rounded transition-colors">
