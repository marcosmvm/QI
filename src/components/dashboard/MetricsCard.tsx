...
export function MetricsCard({
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start">
        <div>
          <p className="text-xs font-medium text-light-text-muted dark:text-steel uppercase tracking-wide mb-2">
            {title}
          </p>
          <p className="text-3xl font-bold text-light-text dark:text-white metric-value">
          ...
          {change !== undefined && (
            ...
            >
              ...
              <span className="text-light-text-muted dark:text-steel ml-1 text-xs">{changeLabel}</span>
            </motion.div>
          )}
        </div>
        {Icon && (
          <div className="w-10 h-10 rounded-lg bg-graphite/50 flex items-center justify-center text-light-text-muted dark:text-steel group-hover:text-emerald-pro-600 group-hover:bg-emerald-pro-600/10 group-hover:border group-hover:border-emerald-pro-600/30 transition-all duration-200">
