        ...
        {groupedMessages.map((group, groupIndex) => (
          <div key={groupIndex}>
            ...
            <div className="flex items-center justify-center my-4">
              <span className="text-xs text-slate-700 dark:text-slate-400 bg-white dark:bg-deep-space px-3 py-1 rounded-full">
                {group.date}
              </span>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className={`text-xs mt-1 ${isOwn ? "text-emerald-pro-600/60" : "text-slate-700 dark:text-slate-400"}`}>
