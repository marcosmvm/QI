    ...
    <header className="sticky top-0 z-30 bg-light-bg/80 dark:bg-deep-space/80 backdrop-blur-xl border-b border-border-default dark:border-graphite">
      ...
      <div className="flex items-center justify-between px-6 py-4">
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : "text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-light-bg-secondary dark:hover:bg-graphite/50"
                    )}
                  >
                    {tab.name}
                  </Link>
        ...
        <div className="flex items-center gap-3">
          {/* Add Widget Button */}
          <button className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-light-bg-secondary dark:hover:bg-midnight-blue rounded-xl transition-colors">
            <Plus className="h-4 w-4" />
            Add widget
          </button>

          {/* Date Range */}
          <button className="flex items-center gap-2 px-4 py-2.5 bg-light-bg-secondary dark:bg-midnight-blue hover:bg-light-surface dark:hover:bg-graphite rounded-xl text-sm font-medium text-slate-600 dark:text-slate-300 transition-colors">
          ...
          {/* Notifications */}
          <button className="relative p-2.5 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-light-bg-secondary dark:hover:bg-midnight-blue rounded-xl transition-colors">
      ...
      {(title || subtitle) && (
        <div className="px-6 pb-4">
          <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300 mb-1">
            <span>Portal</span>
            <span>/</span>
            <span className="text-slate-600 dark:text-slate-300">{title || 'Dashboard'}</span>
          </div>
          {subtitle && (
