...
export function Footer() {
  ...
  return (
    <footer className="border-t border-[#1e293b] py-20 bg-[#0a0f1c]">
      <Container>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          ...
          {/* Product Column */}
          <div>
            <h4 className="font-semibold text-[#f0f0f5] mb-4">Product</h4>
            <ul className="space-y-3">
              {footerNavigation.services.links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[#9ca3af] hover:text-[#00d4ff] transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          {/* Industries Column */}
          <div>
            <h4 className="font-semibold text-[#f0f0f5] mb-4">Industries</h4>
            <ul className="space-y-3">
          ...
          {/* Company Column */}
          <div>
            <h4 className="font-semibold text-[#f0f0f5] mb-4">Company</h4>
            <ul className="space-y-3">
          ...
          {/* Legal Column */}
          <div>
            <h4 className="font-semibold text-[#f0f0f5] mb-4">Legal</h4>
            <ul className="space-y-3">
