            ...
            <ul className="space-y-3">
              {footerNavigation.product.links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-slate-700 dark:text-slate-400 hover:text-emerald-pro-600 dark:hover:text-xgrowth-500 transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        >
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <a
              ...
              className="p-2 rounded-lg text-slate-700 dark:text-slate-400 hover:text-emerald-pro-600 dark:hover:text-xgrowth-500 hover:bg-emerald-pro-600/10 dark:hover:bg-xgrowth-500/10 transition-all duration-300"
            >
