...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-graphite/30 py-20 bg-deep-space overflow-hidden">
      {/* Ambient background orb */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full blur-[150px] bg-[radial-gradient(circle,rgba(0,212,255,0.05)_0%,rgba(0,212,255,0)_70%)]" />
            ...
            <ul className="space-y-3">
              {footerNavigation.product.links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-steel hover:text-electric-cyan transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        >
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <a
              ...
              className="p-2 rounded-lg text-steel hover:text-electric-cyan hover:bg-electric-cyan/10 transition-all duration-300"
            >
