            ...
            <ul className="space-y-3">
              {footerNavigation.product.links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-slate-600 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-green-400 transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        >
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <a
              ...
              className="p-2 rounded-lg text-slate-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-green-400 hover:bg-emerald-100 dark:hover:bg-green-500/10 transition-all duration-300"
            >
