      ...
      <Container className="relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            {!isSubmitted ? (
              <form onSubmit={handleLeadCapture} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-lg input-base text-sm"
                  required
                />
                <button
                  type="submit"
            ...
            <p className="text-slate-500 dark:text-slate-300 text-xs mt-2">Get our free B2B Cold Email Playbook. No spam, unsubscribe anytime.</p>
          </motion.div>
          ...
          >
            {heroStats.map((stat, index) => (
              <motion.div
                ...
                className="p-4 rounded-xl card-base group"
              >
                ...
                <div className="text-slate-600 dark:text-slate-300 text-sm mt-1">{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <p className="text-slate-500 dark:text-slate-300 text-sm mb-4">Built for B2B companies in</p>
