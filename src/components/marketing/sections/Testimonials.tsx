        ...
        <div className="relative max-w-4xl mx-auto">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative"
            >
              <div className="relative p-8 md:p-12 rounded-3xl border border-electric-cyan/20 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90">
                {/* Quote Icon */}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="hidden sm:block text-right">
                    <p className="text-3xl font-sora font-bold text-transparent bg-clip-text bg-gradient-to-r from-electric-cyan to-quantum-violet">
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <button
              onClick={prev}
              className="p-3 rounded-full border border-electric-cyan/20 hover:border-electric-cyan/40 hover:bg-electric-cyan/10 text-steel hover:text-white transition-all"
