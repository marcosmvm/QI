          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-xl bg-quantum-violet/10 border border-quantum-violet/20">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-quantum-violet hover:text-purple-400 transition-colors"
                    >
                      {contactInfo.phone}
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-xl bg-neon-mint/10 border border-neon-mint/20">
                    <MapPin className="h-5 w-5 text-neon-mint" />
                  </div>
                  <div>
                    <p className="text-white font-medium">Location</p>
                    <p className="text-silver">{contactInfo.address}</p>
                  </div>
                </div>
              </div>

              {/* What to Expect */}
              <div className="mt-12 p-6 rounded-2xl border border-electric-cyan/20 bg-gradient-to-br from-midnight-blue/50 to-deep-space/50">
            ...
            >
              <div className="p-8 rounded-3xl border border-electric-cyan/20 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90">
                {submitted ? (
                  <div className="text-center py-12">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-neon-mint/20 border border-neon-mint/30 mb-6">
                      <Send className="h-8 w-8 text-neon-mint" />
                    </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-deep-space border border-electric-cyan/20 text-white placeholder-steel focus:border-electric-cyan/50 focus:ring-1 focus:ring-electric-cyan/50 transition-all outline-none"
                          placeholder="John"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 rounded-xl bg-deep-space border border-electric-cyan/20 text-white focus:border-electric-cyan/50 focus:ring-1 focus:ring-electric-cyan/50 transition-all outline-none"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 rounded-xl bg-deep-space border border-electric-cyan/20 text-white placeholder-steel focus:border-electric-cyan/50 focus:ring-1 focus:ring-electric-cyan/50 transition-all outline-none resize-none"
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-electric-cyan to-cyan-dark hover:from-cyan-light hover:to-electric-cyan text-deep-space font-semibold py-6 disabled:opacity-50"
                    >
                      {isSubmitting ? (
                        "Sending..."
                      ) : (
