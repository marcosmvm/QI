  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-between mb-8">
        <div>
          <p className="text-sm text-slate-700 dark:text-slate-400 mb-1">Admin / <span className="text-emerald-pro-500">Clients</span></p>
          <h1 className="text-2xl font-sora font-bold text-slate-900 dark:text-white">Clients</h1>
          <p className="text-slate-700 dark:text-slate-400 mt-1">Manage your client relationships</p>
        </div>
        <Link
      ...
      <motion.div variants={itemVariants}>
        {clients.length === 0 ? (
          <div className="glass-premium p-12 text-center">
            <Building2 className="h-12 w-12 text-slate-700 dark:text-slate-400 mx-auto mb-4" />
            <p className="text-slate-700 dark:text-slate-400">No clients yet</p>
            <Link
              href="/admin/clients/new"
