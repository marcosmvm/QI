        ...
        <div className="flex items-center gap-4 mb-6 p-4 bg-light-bg-secondary dark:bg-midnight-blue/20 border border-border-default dark:border-graphite/30 rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-8 px-3 rounded-lg input-base text-sm text-slate-900 dark:text-white focus:border-emerald-pro-600/50 focus:outline-none"
            >
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-8 px-2 rounded-lg input-base text-sm text-slate-900 dark:text-white focus:border-emerald-pro-600/50 focus:outline-none"
            >
