    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400">Redirecting to clients list...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="min-h-screen p-8">
      ...
      <motion.div variants={itemVariants}>
        ...
        {/* Header */}
        <div className="mb-8">
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-1">Admin / Clients / <span className="text-emerald-pro-500">New</span></p>
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl">
        <div className="space-y-6">
          ...
          <div className="glass-premium p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">Basic client details</p>
              </div>
            </div>
          ...
          <div className="glass-premium p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">Primary contact details</p>
              </div>
            </div>
          ...
          <div className="glass-premium p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">Plan and billing details</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="0"
                    className="w-full h-11 rounded-lg border border-border-default dark:border-graphite bg-white dark:bg-deep-space pl-8 pr-4 text-slate-900 dark:text-white placeholder:text-slate-500 dark:text-slate-400 focus:border-emerald-pro-600/50 focus:outline-none focus:ring-1 focus:ring-emerald-pro-600/50"
                  />
                </div>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">
          ...
          <div className="flex items-center justify-between pt-4">
            <Link
              href="/admin/clients"
              className="px-4 py-2 border border-border-default dark:border-graphite text-slate-500 dark:text-slate-400 rounded-lg hover:bg-light-bg-secondary dark:bg-midnight-blue/30 transition-colors"
            >
              Cancel
            </Link>
            <Button
