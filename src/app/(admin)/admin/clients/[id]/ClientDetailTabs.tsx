            ...
            <button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "border-transparent text-slate-900 dark:text-slate-300 hover:text-slate-900 dark:text-slate-200"
              )}
            >
          ...
          <button
            ...
            className={cn(
              ...
              stageFilter === stage.value
                ...
                : "bg-white dark:bg-deep-space/30 text-slate-900 dark:text-slate-300 hover:text-slate-900 dark:text-slate-200 border border-transparent"
            )}
          >
            {stage.label}
            {stage.value !== "all" && (
