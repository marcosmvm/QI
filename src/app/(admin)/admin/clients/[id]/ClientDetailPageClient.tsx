              ...
              <div className="flex items-center gap-4 mt-2">
                {client.domain && (
                  <a
                    ...
                    className="flex items-center gap-1 text-sm text-slate-900 dark:text-slate-200 hover:text-emerald-pro-600 transition-colors"
                  >
...
function QuickStat({
  ...
  return (
    <div className="glass-premium p-4 hover:border-emerald-pro-600/30 hover:-translate-y-0.5 hover:shadow-card-hover transition-all duration-300">
      <p className="text-xs text-slate-900 dark:text-slate-200 mb-1">{label}</p>
      <p
      ...
      {subtext && <p className="text-xs text-slate-900 dark:text-slate-200 mt-1">{subtext}</p>}
    </div>
  );
}
