    ...
    <div>
        ...
        <button
          ...
          className={cn(
            ...
            showFilters || hasActiveFilters
              ...
              : "border-border-default dark:border-graphite text-slate-900 dark:text-slate-300 hover:bg-light-bg-secondary dark:bg-midnight-blue/30"
          )}
        >
      ...
      {showFilters && (
        <div className="flex items-center gap-4 mb-6 p-4 bg-light-bg-secondary dark:bg-midnight-blue/20 border border-border-default dark:border-graphite/30 rounded-lg">
          ...
          {/* Client Filter */}
          <div className="flex items-center gap-2">
            <label className="text-xs text-slate-900 dark:text-slate-300">Client:</label>
            <select
              value={clientFilter}
              onChange={(e) => {
            ...
            {paginatedCampaigns.length === 0 ? (
              <tr>
                <td colSpan={8} className="px-6 py-12 text-center">
                  <p className="text-slate-900 dark:text-slate-300">No campaigns match your filters</p>
                  <button
                    onClick={clearFilters}
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <Link
                      ...
                      className="text-sm text-slate-900 dark:text-slate-300 hover:text-emerald-pro-600 transition-colors"
                    >
                      {campaign.clientName}
                    </Link>
                  </td>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between mt-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-slate-900 dark:text-slate-300 px-3">
    ...
    <th className="text-left px-6 py-4">
      <button
        ...
        className={cn(
          ...
          isActive ? "text-emerald-pro-600" : "text-slate-900 dark:text-slate-300 hover:text-slate-900 dark:text-slate-300"
        )}
      >
        {label}
        <ChevronDown
