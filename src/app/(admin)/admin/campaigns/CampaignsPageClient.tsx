    ...
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="min-h-screen p-8">
      ...
      <motion.div variants={itemVariants}>
        <div className="flex items-center justify-between mb-8">
          <div>
            <p className="text-sm text-slate-900 dark:text-slate-200 mb-1">Admin / <span className="text-emerald-pro-600">Campaigns</span></p>
...
function StatCard({
  ...
  const colorClasses: Record<string, string> = {
    ...
    steel: "text-slate-900 dark:text-slate-200",
  };
