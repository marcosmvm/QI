            ...
            {openConversations.length === 0 ? (
              ...
              openConversations.map((conv) => (
                <Link
                  ...
                  className="flex items-center justify-between p-3 card-base rounded-xl hover:border-emerald-pro-500/30 hover:-translate-y-0.5 hover:shadow-card-hover transition-all duration-200"
                >
                  <div className="flex items-center gap-3">
                    <div
