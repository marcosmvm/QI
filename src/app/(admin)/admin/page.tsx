  ...
  return (
    <div className="min-h-screen p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-900 dark:text-slate-200 mt-1">Overview of your business operations</p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          ...
          <div className="bg-steel/10 border border-steel/30 rounded-xl p-4 text-center">
            <p className="text-2xl font-sora font-bold text-slate-900 dark:text-slate-200">
              {healthDistribution.unknown}
            </p>
            <p className="text-xs text-slate-900 dark:text-slate-200 mt-1">No Data</p>
          </div>
        </div>
      </div>
        ...
        <div className="glass-premium p-6">
          ...
          <div className="space-y-4">
            {recentClients.length === 0 ? (
              <p className="text-slate-900 dark:text-slate-200 text-sm">No clients yet</p>
            ) : (
          ...
          <div className="space-y-4">
            {openConversations.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-slate-900 dark:text-slate-200 text-sm">All caught up!</p>
                <p className="text-slate-900 dark:text-slate-200/60 text-xs">No open support tickets</p>
              </div>
            ) : (
