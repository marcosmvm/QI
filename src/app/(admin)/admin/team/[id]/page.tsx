  ...
  if (loading || !member) {
    return (
      <div className="min-h-screen p-8 flex items-center justify-center">
        <div className="text-slate-700 dark:text-slate-400">Loading...</div>
      </div>
    );
  }
  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="min-h-screen p-8">
      ...
      <motion.div variants={itemVariants} className="mb-6">
        <div className="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-400 mb-4">
          ...
          <div className="glass-premium p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">{role.description}</p>
              </div>
            </div>
              ...
              {Object.entries(permissions).map(([key, value]) => (
                ...
                >
                  ...
                  {value ? (
                    ...
                    <X className="h-4 w-4 text-slate-700 dark:text-slate-400" />
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="glass-premium p-6">
            ...
            {assignedClients.length === 0 ? (
              <div className="text-center py-8">
                <Users className="h-10 w-10 text-slate-700 dark:text-slate-400 mx-auto mb-3" />
                <p className="text-slate-700 dark:text-slate-400 text-sm">No clients assigned</p>
              </div>
            ) : (
          ...
          <div className="glass-premium p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">Last 10 actions</p>
              </div>
            </div>

            {activityLogs.length === 0 ? (
              <div className="text-center py-8">
                <Clock className="h-10 w-10 text-slate-700 dark:text-slate-400 mx-auto mb-3" />
                <p className="text-slate-700 dark:text-slate-400 text-sm">No activity recorded</p>
              </div>
            ) : (
              <div className="space-y-3">
