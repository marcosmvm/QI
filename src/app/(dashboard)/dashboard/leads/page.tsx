                    ...
                    {stageLeads.map((lead) => {
                      ...
                      return (
                        <Link
                          ...
                          className="block rounded-xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-4 hover:border-electric-cyan/30 hover:-translate-y-1 hover:shadow-[0_8px_25px_-5px_rgba(0,0,0,0.3),0_0_15px_rgba(0,212,255,0.1)] transition-all duration-200 group cursor-pointer"
                        >
