                    ...
                    {stageLeads.map((lead) => {
                      ...
                      return (
                        <Link
                          ...
                          className="block rounded-xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-4 hover:border-electric-cyan/30 transition-all group cursor-pointer"
                        >
