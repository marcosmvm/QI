    ...
    return (
      <div className="min-h-screen p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-900 dark:text-slate-200">Please complete your onboarding first.</p>
        </div>
      </div>
    );
  }
    ...
    <SupportPageWrapper>
      <div className="h-screen flex flex-col">
        ...
        <div className="p-4 border-b border-border-default dark:border-graphite/50 bg-light-bg-secondary dark:bg-midnight-blue/50 flex-shrink-0">
          <div className="flex items-center gap-2 text-sm text-slate-900 dark:text-slate-200 mb-1">
          ...
          <p className="text-slate-900 dark:text-slate-200 text-sm">Get help from our team</p>
        </div>
            ...
            <div className="flex-1 overflow-y-auto">
              {conversations.length === 0 ? (
                <div className="p-4 text-center">
                  <p className="text-slate-900 dark:text-slate-200 text-sm">No conversations yet</p>
                </div>
              ) : (
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <span className={`text-xs px-2 py-0.5 rounded-full capitalize ${
                          conv.status === "open"
                            ...
                            : "bg-steel/10 text-slate-900 dark:text-slate-200"
                        }`}>
                          {conv.status}
                        </span>
                      </div>
          ...
          <div className="flex-1 flex flex-col bg-white dark:bg-deep-space/50">
            {activeConversationId ? (
                ...
                <div className="p-4 border-b border-border-default dark:border-graphite/50 bg-light-bg-secondary dark:bg-midnight-blue/30 backdrop-blur-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-900 dark:text-slate-200">We typically reply within a few hours</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  <MessageSquare className="h-12 w-12 text-slate-900 dark:text-slate-200 mx-auto mb-4" />
                  <p className="text-slate-900 dark:text-slate-200">Select a conversation to continue</p>
                </div>
              </div>
            )}
          </div>
