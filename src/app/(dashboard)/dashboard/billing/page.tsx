    ...
    <div className="min-h-screen bg-deep-space p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {invoices.length === 0 ? (
              ...
              <div className="space-y-3">
                {invoices.map((invoice) => (
                  <div
                    key={invoice.id}
                    className="flex items-center justify-between p-4 bg-deep-space/50 border border-graphite/30 rounded-lg"
                  >
                    <div className="flex items-center gap-4">
                      <div
        ...
        <div className="space-y-6">
          ...
          {/* Support */}
          <div className="bg-deep-space/50 border border-graphite/30 rounded-xl p-4">
