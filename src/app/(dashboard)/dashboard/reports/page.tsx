  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-8">
        ...
        <p className="text-slate-700 dark:text-slate-400 mt-1">Automated reports and performance insights</p>
      </motion.div>
                ...
                {showDatePicker && (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button onClick={() => setShowDatePicker(false)} className="text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">
                        <X className="h-4 w-4" />
                      </button>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-700 dark:text-slate-400">{report.date}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6">
                      <div className="hidden md:flex items-center gap-6 text-sm">
                        <div className="text-center">
                          <p className="text-xs text-slate-700 dark:text-slate-400">Sent</p>
                          <p className="text-slate-900 dark:text-white font-medium">{report.metrics.sent.toLocaleString()}</p>
                        </div>
                        <div className="text-center">
                          <p className="text-xs text-slate-700 dark:text-slate-400">Open Rate</p>
            ...
            <div className="glass-premium p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-slate-700 dark:text-slate-400">{selectedReport.date}</p>
                </div>
                <div className="flex items-center gap-2">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <metric.icon className="h-4 w-4 text-slate-700 dark:text-slate-400" />
                      <div className={cn(
                    ...
                    <p className="text-xs text-slate-700 dark:text-slate-400 mt-1">{metric.label}</p>
                  </div>
                ))}
              </div>
                  ...
                  {latestInsights.map((insight, index) => (
                    <div key={index} className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-700 dark:text-slate-400">{insight.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                {scheduledReports.map((report) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-700 dark:text-slate-400 mb-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <p className="text-[10px] text-slate-700 dark:text-slate-400">Last: {report.lastSent}</p>
                    </div>
                  </div>
                ))}
              </div>

              <Button variant="outline" className="w-full mt-4 border-emerald-pro-600/20 text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-slate-700 dark:text-slate-400">{option.description}</p>
                    </div>
                    <Download className="h-4 w-4 text-slate-700 dark:text-slate-400 group-hover:text-emerald-pro-600 transition-colors" />
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="glass-premium p-5">
              ...
              <div className="space-y-2">
                <Button
                  variant="outline"
                  className="w-full justify-start border-emerald-pro-600/20 text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"
            ...
            >
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <p className="text-slate-700 dark:text-slate-400">{previewReport.date}</p>
                </div>
                ...
                <div className="grid grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="p-4 rounded-xl border border-energy-orange/20 bg-energy-orange/5">
                    ...
                    <p className="text-xs text-slate-700 dark:text-slate-400">Meetings Booked</p>
                  </div>
                </div>
