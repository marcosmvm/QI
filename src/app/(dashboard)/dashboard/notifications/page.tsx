    ...
    <div className="min-h-screen p-8">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-900 dark:text-slate-300">{config.label}</p>
                </div>
              </div>
            </div>
          );
      ...
      {notifications.length === 0 ? (
        <div className="glass-premium p-12 text-center">
          <Bell className="h-12 w-12 text-slate-900 dark:text-slate-300 mx-auto mb-4" />
          <p className="text-slate-900 dark:text-slate-300">No notifications yet</p>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-900 dark:text-slate-300 mt-1">{notification.message}</p>
          </div>
        ...
        {notification.action_url && (
          <div className="mt-3 flex items-center gap-3">
            ...
            <button className="text-sm text-slate-900 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white">
              <Check className="h-4 w-4" />
            </button>
            <button className="text-sm text-slate-900 dark:text-slate-300 hover:text-energy-orange">
