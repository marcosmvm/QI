  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="min-h-screen p-8">
      ...
      <motion.div variants={itemVariants} className="mb-8">
        ...
        <p className="text-slate-700 dark:text-slate-400 mt-1">Website Visitor Intelligence Engine</p>
      </motion.div>
      ...
      <div className="space-y-6">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-slate-700 dark:text-slate-400 mt-1">Identifying anonymous visitors and revealing buyer intent</p>
              </div>
            </div>

            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm text-slate-700 dark:text-slate-400">Last Update</p>
                <p className="text-slate-900 dark:text-white font-medium">{overallStats.lastCheck}</p>
              </div>
              <div className="text-right">
                <p className="text-sm text-slate-700 dark:text-slate-400">Live Visitors</p>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="glass-premium p-6">
            ...
            <p className="text-sm text-slate-700 dark:text-slate-400 mt-1">Visitors Identified</p>
            <p className="text-xs text-slate-700 dark:text-slate-400 mt-2">Last 30 days</p>
          </div>
          ...
          <div className="glass-premium p-6">
            ...
            <p className="text-sm text-slate-700 dark:text-slate-400 mt-1">Companies Revealed</p>
            <p className="text-xs text-slate-700 dark:text-slate-400 mt-2">Unique organizations</p>
          </div>
          ...
          <div className="glass-premium p-6">
            ...
            <p className="text-sm text-slate-700 dark:text-slate-400 mt-1">High Intent Leads</p>
            <p className="text-xs text-slate-700 dark:text-slate-400 mt-2">Score 80+</p>
          </div>
          ...
          <div className="glass-premium p-6">
            ...
            <p className="text-sm text-slate-700 dark:text-slate-400 mt-1">Identification Rate</p>
            <p className="text-xs text-slate-700 dark:text-slate-400 mt-2">Industry avg: 8%</p>
          </div>
        </motion.div>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3 text-sm text-slate-700 dark:text-slate-400 mt-0.5">
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-2">
                          <span className="text-sm text-slate-700 dark:text-slate-400">Intent Score:</span>
                          <span className={cn(
                            "text-lg font-bold",
                            visitor.intentScore >= 80 ? "text-emerald-pro-400" :
                            visitor.intentScore >= 50 ? "text-energy-orange" : "text-slate-700 dark:text-slate-400"
                          )}>
                            {visitor.intentScore}
                          </span>
                        </div>
                        <p className="text-xs text-slate-700 dark:text-slate-400 mt-0.5">{visitor.lastVisit}</p>
                      </div>
                    </div>

                    <div className="grid grid-cols-4 gap-4 mt-4 pt-4 border-t border-border-default dark:border-graphite/30">
                      <div className="text-center">
                        <p className="text-xs text-slate-700 dark:text-slate-400">Visits</p>
                        <p className="text-sm font-semibold text-slate-900 dark:text-white">{visitor.visits}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-xs text-slate-700 dark:text-slate-400">Duration</p>
                        <p className="text-sm font-semibold text-slate-900 dark:text-white">{visitor.duration}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-xs text-slate-700 dark:text-slate-400">Employees</p>
                        <p className="text-sm font-semibold text-slate-900 dark:text-white">{visitor.employees}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-xs text-slate-700 dark:text-slate-400">Revenue</p>
                        <p className="text-sm font-semibold text-slate-900 dark:text-white">{visitor.revenue}</p>
                      </div>
                    </div>

                    <div className="flex items-center gap-2 mt-3">
                      <span className="text-xs text-slate-700 dark:text-slate-400">Pages:</span>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-700 dark:text-slate-400">{signal.weight} weight</p>
                      </div>
                    </div>
                ...
                {industryBreakdown.map((item, index) => (
                  <div key={index}>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm text-slate-700 dark:text-slate-400">{item.count}</span>
                    </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-700 dark:text-slate-400">{page.visits.toLocaleString()} visits</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold text-emerald-pro-400">{page.conversionRate}%</p>
                    <p className="text-xs text-slate-700 dark:text-slate-400">conversion</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-border-default dark:border-graphite/30">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="text-center p-3 rounded-lg bg-white dark:bg-deep-space/50 border border-border-default dark:border-graphite/30">
                  ...
                  <p className="text-xs text-slate-700 dark:text-slate-400">New Companies</p>
                </div>
                <div className="text-center p-3 rounded-lg bg-white dark:bg-deep-space/50 border border-border-default dark:border-graphite/30">
                  <p className="text-lg font-bold text-emerald-pro-400">156</p>
                  <p className="text-xs text-slate-700 dark:text-slate-400">Hot Leads</p>
                </div>
                <div className="text-center p-3 rounded-lg bg-white dark:bg-deep-space/50 border border-border-default dark:border-graphite/30">
                  <p className="text-lg font-bold text-emerald-pro-500">34</p>
                  <p className="text-xs text-slate-700 dark:text-slate-400">Added to CRM</p>
                </div>
              </div>
            </div>
          </div>
