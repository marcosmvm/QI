  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-8">
        ...
        <h1 className="text-2xl font-sora font-bold text-light-text dark:text-white">The Guardian</h1>
        <p className="text-light-text-muted dark:text-steel mt-1">Compliance & Deliverability Engine</p>
      </motion.div>
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h2 className="text-2xl font-sora font-bold text-light-text dark:text-white">Guardian Engine</h2>
                ...
                <p className="text-light-text-muted dark:text-steel mt-1">Protecting your sender reputation 24/7</p>
              </div>
            </div>

            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm text-light-text-muted dark:text-steel">Last Check</p>
                <p className="text-light-text dark:text-white font-medium">{overallHealth.lastCheck}</p>
              </div>
              <div className="text-right">
                <p className="text-sm text-light-text-muted dark:text-steel">Next Check</p>
                <p className="text-light-text dark:text-white font-medium">{overallHealth.nextCheck}</p>
              </div>
              <Button
                variant="outline"
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 glass-premium p-6">
            ...
            <h3 className="text-sm font-medium text-light-text-muted dark:text-steel mb-4">Overall Health Score</h3>
            <div className="flex flex-col items-center justify-center py-4">
              <div className="relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-4xl font-sora font-bold text-light-text dark:text-white">{overallHealth.score}</span>
                  <span className="text-sm text-light-text-muted dark:text-steel">/100</span>
                </div>
              </div>
              <span className={cn(
          ...
          <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="glass-premium p-6">
              ...
              <p className="text-3xl font-sora font-bold text-light-text dark:text-white">99.2%</p>
              <p className="text-sm text-light-text-muted dark:text-steel mt-1">Inbox Placement</p>
              <p className="text-xs text-light-text-muted dark:text-steel mt-2">Target: &gt;98%</p>
            </div>
            ...
            <div className="glass-premium p-6">
              ...
              <p className="text-3xl font-sora font-bold text-light-text dark:text-white">0.3%</p>
              <p className="text-sm text-light-text-muted dark:text-steel mt-1">Spam Rate</p>
              <p className="text-xs text-light-text-muted dark:text-steel mt-2">Target: &lt;1%</p>
            </div>

            <div className="glass-premium p-6">
              <div className="flex items-center justify-between mb-3">
                <Activity className="h-5 w-5 text-emerald-pro-600" />
                <span className="text-light-text-muted dark:text-steel text-sm font-medium">Same</span>
              </div>
              <p className="text-3xl font-sora font-bold text-light-text dark:text-white">0.5%</p>
              <p className="text-sm text-light-text-muted dark:text-steel mt-1">Bounce Rate</p>
              <p className="text-xs text-light-text-muted dark:text-steel mt-2">Target: &lt;2%</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 glass-premium p-6 overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-sora font-semibold text-light-text dark:text-white">Mailbox Health</h3>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border-default dark:border-graphite/50">
                    <th className="text-left text-sm font-medium text-light-text-muted dark:text-steel pb-4">Mailbox</th>
                    <th className="text-center text-sm font-medium text-light-text-muted dark:text-steel pb-4">Health</th>
                    <th className="text-center text-sm font-medium text-light-text-muted dark:text-steel pb-4">Inbox Rate</th>
                    <th className="text-center text-sm font-medium text-light-text-muted dark:text-steel pb-4">Status</th>
                    <th className="text-right text-sm font-medium text-light-text-muted dark:text-steel pb-4">Last Check</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <tr key={index} className="border-b border-border-default dark:border-graphite/30 last:border-0 hover:bg-emerald-pro-600/5 transition-colors">
                        <td className="py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-light-text dark:text-white font-medium">{mailbox.email}</span>
                          </div>
                        </td>
                        ...
                        <td className="py-4 text-right text-sm text-light-text-muted dark:text-steel">{mailbox.lastCheck}</td>
                      </tr>
                    );
                  })}
                </tbody>
          ...
          <div className="space-y-6">
            {/* DNS Records */}
            <div className="glass-premium p-6">
              <h3 className="text-lg font-sora font-semibold text-light-text dark:text-white mb-4">DNS Records</h3>
                  ...
                  return (
                    <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-white dark:bg-deep-space/50 border border-border-default dark:border-graphite/30">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-light-text dark:text-white">{record.name}</span>
                      </div>
            ...
            {/* Blacklist Status */}
            <div className="glass-premium p-6">
              <h3 className="text-lg font-sora font-semibold text-light-text dark:text-white mb-4">Blacklist Status</h3>
              <div className="text-center py-4">
                ...
                <p className="text-sm text-light-text-muted dark:text-steel">Checked: {blacklistStatus.checked} blacklists</p>
                <div className="flex justify-center gap-6 mt-4 text-sm">
                  <div>
                    <p className="text-light-text-muted dark:text-steel">Last Check</p>
                    <p className="text-light-text dark:text-white">{blacklistStatus.lastCheck}</p>
                  </div>
                  <div>
                    <p className="text-light-text-muted dark:text-steel">Next Check</p>
                    <p className="text-light-text dark:text-white">{blacklistStatus.nextCheck}</p>
                  </div>
                </div>
              </div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="glass-premium p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-sora font-semibold text-light-text dark:text-white">Inbox Placement by Provider</h3>
              <Button variant="ghost" size="sm" className="text-emerald-pro-600 hover:text-emerald-pro-600/80">
                Run Test
              </Button>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-light-text dark:text-white font-medium">Gmail</span>
                ...
                <div className="flex justify-between mt-1 text-xs text-light-text-muted dark:text-steel">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-light-text dark:text-white font-medium">Outlook / Microsoft 365</span>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-light-text dark:text-white font-medium">Yahoo / AOL</span>
            ...
            <div className="mt-6 p-3 rounded-lg bg-energy-orange/10 border border-energy-orange/30">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm text-light-text dark:text-white font-medium">Outlook showing higher junk placement</p>
                  <p className="text-xs text-light-text-muted dark:text-steel mt-1">Reduce HTML formatting and image-to-text ratio</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-premium p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-sora font-semibold text-light-text dark:text-white">Do Not Contact Check</h3>
            </div>
            ...
            <div className="flex gap-3">
              <div className="relative flex-1">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-light-text-muted dark:text-steel" />
                <input
                  type="email"
                  value={dncEmail}
                  onChange={(e) => {
                  ...
                  className="w-full h-11 rounded-lg border border-border-default dark:border-graphite bg-white dark:bg-deep-space pl-10 pr-4 text-light-text dark:text-white placeholder:text-light-text-muted dark:text-steel focus:border-emerald-pro-600/50 focus:outline-none focus:ring-1 focus:ring-emerald-pro-600/50"
                />
              </div>
            ...
            {/* Recent Alerts */}
            <div className="mt-8">
              <h4 className="text-sm font-medium text-light-text dark:text-white mb-4">Recent Alerts</h4>
                ...
                {recentAlerts.map((alert, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm text-light-text dark:text-white truncate">{alert.message}</p>
                      <p className="text-xs text-light-text-muted dark:text-steel mt-0.5">{alert.time}</p>
                    </div>
                    {alert.resolved && (
