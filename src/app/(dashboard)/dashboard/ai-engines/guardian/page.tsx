...
export default function GuardianPage() {
  ...
  return (
    <div className="min-h-screen">
      <Header
        title="The Guardian"
        subtitle="Compliance & Deliverability Engine"
      />
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="relative rounded-2xl border border-neon-mint/20 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-6 overflow-hidden">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-neon-mint/10 border border-neon-mint/30">
                <Shield className="h-8 w-8 text-neon-mint" />
              </div>
              <div>
                <div className="flex items-center gap-3">
                  <h2 className="text-2xl font-sora font-bold text-white">Guardian Engine</h2>
                ...
                <p className="text-steel mt-1">Protecting your sender reputation 24/7</p>
              </div>
            </div>

            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm text-steel">Last Check</p>
                <p className="text-white font-medium">{overallHealth.lastCheck}</p>
              </div>
              <div className="text-right">
                <p className="text-sm text-steel">Next Check</p>
                <p className="text-white font-medium">{overallHealth.nextCheck}</p>
              </div>
              <Button
                variant="outline"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="flex flex-col items-center justify-center py-4">
              <div className="relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-4xl font-sora font-bold text-white">{overallHealth.score}</span>
                  <span className="text-sm text-steel">/100</span>
                </div>
              </div>
              <span className={cn(
          ...
          <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-2xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-6">
              ...
              <p className="text-3xl font-sora font-bold text-white">99.2%</p>
              <p className="text-sm text-steel mt-1">Inbox Placement</p>
            ...
            <div className="rounded-2xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-6">
              ...
              <p className="text-3xl font-sora font-bold text-white">0.3%</p>
              <p className="text-sm text-steel mt-1">Spam Rate</p>
            ...
            <div className="rounded-2xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-6">
              ...
              <p className="text-3xl font-sora font-bold text-white">0.5%</p>
              <p className="text-sm text-steel mt-1">Bounce Rate</p>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-graphite/50">
                    <th className="text-left text-sm font-medium text-steel pb-4">Mailbox</th>
                    <th className="text-center text-sm font-medium text-steel pb-4">Health</th>
                    <th className="text-center text-sm font-medium text-steel pb-4">Inbox Rate</th>
                    <th className="text-center text-sm font-medium text-steel pb-4">Status</th>
                    <th className="text-right text-sm font-medium text-steel pb-4">Last Check</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <tr key={index} className="border-b border-graphite/30 last:border-0 hover:bg-electric-cyan/5 transition-colors">
                        <td className="py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-white font-medium">{mailbox.email}</span>
                          </div>
                        </td>
                        <td className="py-4 text-center">
                          <span className={cn("font-semibold", mailbox.health >= 95 ? "text-neon-mint" : mailbox.health >= 90 ? "text-energy-orange" : "text-rose")}>
                            {mailbox.health}%
                          </span>
                        </td>
                        <td className="py-4 text-center">
                        ...
                        <td className="py-4 text-right text-sm text-steel">{mailbox.lastCheck}</td>
                      </tr>
                    );
                  })}
                </tbody>
            ...
            <div className="rounded-2xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-6">
              ...
              <div className="space-y-3">
                {dnsRecords.map((record, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-deep-space/50 border border-graphite/30">
                      <div className="flex items-center gap-3">
            ...
            <div className="rounded-2xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-6">
              ...
              <div className="text-center py-4">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="text-xl font-sora font-bold text-neon-mint">ALL CLEAR</span>
                </div>
                <p className="text-sm text-steel">Checked: {blacklistStatus.checked} blacklists</p>
                <div className="flex justify-center gap-6 mt-4 text-sm">
                  <div>
                    <p className="text-steel">Last Check</p>
                    <p className="text-white">{blacklistStatus.lastCheck}</p>
                  </div>
                  <div>
                    <p className="text-steel">Next Check</p>
                    <p className="text-white">{blacklistStatus.nextCheck}</p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-neon-mint font-semibold">{inboxPlacement.gmail.inbox}% Inbox</span>
                </div>
                <div className="flex h-3 rounded-full overflow-hidden bg-graphite/30">
                  <div className="bg-neon-mint" style={{ width: `${inboxPlacement.gmail.inbox}%` }} />
                ...
                <div className="flex justify-between mt-1 text-xs text-steel">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-white font-medium">Outlook / Microsoft 365</span>
                  <span className="text-neon-mint font-semibold">{inboxPlacement.outlook.inbox}% Inbox</span>
                </div>
                <div className="flex h-3 rounded-full overflow-hidden bg-graphite/30">
                  <div className="bg-neon-mint" style={{ width: `${inboxPlacement.outlook.inbox}%` }} />
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-white font-medium">Yahoo / AOL</span>
                  <span className="text-neon-mint font-semibold">{inboxPlacement.yahoo.inbox}% Inbox</span>
                </div>
                <div className="flex h-3 rounded-full overflow-hidden bg-graphite/30">
                  <div className="bg-neon-mint" style={{ width: `${inboxPlacement.yahoo.inbox}%` }} />
            ...
            <div className="mt-6 p-3 rounded-lg bg-energy-orange/10 border border-energy-orange/30">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm text-white font-medium">Outlook showing higher junk placement</p>
                  <p className="text-xs text-steel mt-1">Reduce HTML formatting and image-to-text ratio</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-electric-cyan/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-6">
            ...
            {/* Recent Alerts */}
            <div className="mt-8">
              <h4 className="text-sm font-medium text-white mb-4">Recent Alerts</h4>
              <div className="space-y-2">
                {recentAlerts.map((alert, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-3 p-3 rounded-lg bg-deep-space/50 border border-graphite/30"
                  >
                    {alert.type === "critical" ? (
                      ...
                      <CheckCircle className="h-4 w-4 text-neon-mint mt-0.5" />
                    )}
                    ...
                    {alert.resolved && (
                      <span className="text-xs text-neon-mint">Resolved</span>
                    )}
                  </div>
                ))}
              </div>
