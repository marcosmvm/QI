  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-8">
        ...
        <p className="text-slate-700 dark:text-slate-400 mt-1">Compliance & Deliverability Engine</p>
      </motion.div>
      ...
      <div className="space-y-6">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-slate-700 dark:text-slate-400 mt-1">Protecting your sender reputation 24/7</p>
              </div>
            </div>

            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm text-slate-700 dark:text-slate-400">Last Check</p>
                <p className="text-slate-900 dark:text-white font-medium">{overallHealth.lastCheck}</p>
              </div>
              <div className="text-right">
                <p className="text-sm text-slate-700 dark:text-slate-400">Next Check</p>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 glass-premium p-6">
            ...
            <h3 className="text-sm font-medium text-slate-700 dark:text-slate-400 mb-4">Overall Health Score</h3>
            <div className="flex flex-col items-center justify-center py-4">
              <div className="relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  <span className="text-sm text-slate-700 dark:text-slate-400">/100</span>
                </div>
              </div>
              <span className={cn(
          ...
          <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="glass-premium p-6">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-400 mt-1">Inbox Placement</p>
              <p className="text-xs text-slate-700 dark:text-slate-400 mt-2">Target: &gt;98%</p>
            </div>
            ...
            <div className="glass-premium p-6">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-400 mt-1">Spam Rate</p>
              <p className="text-xs text-slate-700 dark:text-slate-400 mt-2">Target: &lt;1%</p>
            </div>

            <div className="glass-premium p-6">
              <div className="flex items-center justify-between mb-3">
                <Activity className="h-5 w-5 text-emerald-pro-600" />
                <span className="text-slate-700 dark:text-slate-400 text-sm font-medium">Same</span>
              </div>
              <p className="text-3xl font-sora font-bold text-slate-900 dark:text-white">0.5%</p>
              <p className="text-sm text-slate-700 dark:text-slate-400 mt-1">Bounce Rate</p>
              <p className="text-xs text-slate-700 dark:text-slate-400 mt-2">Target: &lt;2%</p>
            </div>
          </div>
        </motion.div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border-default dark:border-graphite/50">
                    <th className="text-left text-sm font-medium text-slate-700 dark:text-slate-400 pb-4">Mailbox</th>
                    <th className="text-center text-sm font-medium text-slate-700 dark:text-slate-400 pb-4">Health</th>
                    <th className="text-center text-sm font-medium text-slate-700 dark:text-slate-400 pb-4">Inbox Rate</th>
                    <th className="text-center text-sm font-medium text-slate-700 dark:text-slate-400 pb-4">Status</th>
                    <th className="text-right text-sm font-medium text-slate-700 dark:text-slate-400 pb-4">Last Check</th>
                  </tr>
                </thead>
                <tbody>
                  {mailboxes.map((mailbox, index) => {
                    ...
                    return (
                      <tr key={index} className="border-b border-border-default dark:border-graphite/30 last:border-0 hover:bg-emerald-pro-600/5 transition-colors">
                        ...
                        <td className="py-4 text-center">
                          <span className="text-slate-700 dark:text-slate-200">{mailbox.inboxRate}%</span>
                        </td>
                        <td className="py-4 text-center">
                          <span className={cn(
                        ...
                        <td className="py-4 text-right text-sm text-slate-700 dark:text-slate-400">{mailbox.lastCheck}</td>
                      </tr>
                    );
                  })}
                </tbody>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-premium p-6">
              ...
              <div className="text-center py-4">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">Checked: {blacklistStatus.checked} blacklists</p>
                <div className="flex justify-center gap-6 mt-4 text-sm">
                  <div>
                    <p className="text-slate-700 dark:text-slate-400">Last Check</p>
                    <p className="text-slate-900 dark:text-white">{blacklistStatus.lastCheck}</p>
                  </div>
                  <div>
                    <p className="text-slate-700 dark:text-slate-400">Next Check</p>
          ...
          <div className="glass-premium p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex justify-between mt-1 text-xs text-slate-700 dark:text-slate-400">
            ...
            <div className="mt-6 p-3 rounded-lg bg-energy-orange/10 border border-energy-orange/30">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-700 dark:text-slate-400 mt-1">Reduce HTML formatting and image-to-text ratio</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-premium p-6">
            ...
            <div className="flex gap-3">
              <div className="relative flex-1">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-700 dark:text-slate-400" />
                <input
                  type="email"
                  value={dncEmail}
                  onChange={(e) => {
                  ...
                  className="w-full h-11 rounded-lg border border-border-default dark:border-graphite bg-white dark:bg-deep-space pl-10 pr-4 text-slate-900 dark:text-white placeholder:text-slate-700 dark:text-slate-400 focus:border-emerald-pro-600/50 focus:outline-none focus:ring-1 focus:ring-emerald-pro-600/50"
                />
              </div>
