...
const impactColors = {
  ...
  low: { bg: "bg-steel/10", text: "text-slate-700 dark:text-slate-400", border: "border-steel/20" },
};
  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="min-h-screen p-8">
      ...
      <motion.div variants={itemVariants} className="mb-8">
        ...
        <p className="text-slate-700 dark:text-slate-400 mt-1">Campaign Optimization & A/B Testing Intelligence</p>
      </motion.div>
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">Real-time optimization, A/B testing, and performance intelligence</p>
              </div>
            </div>
            ...
            <div className="col-span-2 glass-premium p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-slate-700 dark:text-slate-400">Best engagement windows for your campaigns</p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <span className="h-3 w-3 rounded-full bg-emerald-pro-600"></span>
                    <span className="text-xs text-slate-700 dark:text-slate-400">Opens</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="h-3 w-3 rounded-full bg-emerald-pro-400"></span>
                    <span className="text-xs text-slate-700 dark:text-slate-400">Replies</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-end gap-2 h-48">
                {hourlyPerformance.map((hour) => (
                  <div key={hour.hour} className="flex-1 flex flex-col items-center gap-1">
                    ...
                    <span className="text-[10px] text-slate-700 dark:text-slate-400 mt-2">{hour.hour}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="rounded-xl border border-emerald-pro-600/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-700 dark:text-slate-400">Currently running experiments</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {activeTests.filter(t => t.status === "running").slice(0, 3).map((test) => (
                    <div key={test.id} className="p-3 rounded-lg bg-white dark:bg-deep-space/50 border border-emerald-pro-600/10">
                      ...
                      <p className="text-xs text-slate-700 dark:text-slate-400">Leading: Variant {test.winner}</p>
                    </div>
                  ))}
                </div>
              ...
              <div className="rounded-xl border border-emerald-pro-600/10 bg-gradient-to-br from-midnight-blue/80 to-deep-space/90 p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-700 dark:text-slate-400">Successful optimizations</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-emerald-pro-400/5 border border-emerald-pro-400/20">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-700 dark:text-slate-400">CTA Variation Test</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-emerald-pro-400/5 border border-emerald-pro-400/20">
                    <CheckCircle2 className="h-5 w-5 text-emerald-pro-400" />
                    <div>
                      ...
                      <p className="text-xs text-slate-700 dark:text-slate-400">List cleaning applied</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-emerald-pro-400/5 border border-emerald-pro-400/20">
                    <CheckCircle2 className="h-5 w-5 text-emerald-pro-400" />
                    <div>
                      ...
                      <p className="text-xs text-slate-700 dark:text-slate-400">Subject line optimization</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                >
                    ...
                    {test.variants.map((variant, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {variant.subject !== "-" && (
                            <p className="text-xs text-slate-700 dark:text-slate-400 mb-3 truncate">
                          ...
                          <div className="grid grid-cols-4 gap-3">
                            ...
                            <div>
                              <p className="text-xs text-slate-700 dark:text-slate-400">Opens</p>
                  ...
                  <div className="flex items-center justify-between p-4 rounded-xl bg-white dark:bg-deep-space/50 border border-emerald-pro-600/10">
                    <div className="flex items-center gap-6">
                      <div>
                        <p className="text-xs text-slate-700 dark:text-slate-400">Statistical Confidence</p>
                        <p className="text-lg font-semibold text-emerald-pro-600">{test.confidence}%</p>
                      </div>
                      <div className="h-8 w-px bg-emerald-pro-600/20" />
                      <div>
                        <p className="text-xs text-slate-700 dark:text-slate-400">Improvement</p>
                        <p className="text-lg font-semibold text-emerald-pro-400">{test.improvement}</p>
                      </div>
                      <div className="h-8 w-px bg-emerald-pro-600/20" />
                      <div>
                        <p className="text-xs text-slate-700 dark:text-slate-400">Recommended Action</p>
            ...
            {recommendations.map((rec) => {
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-700 dark:text-slate-400">{rec.campaign}</p>
                      </div>
                    </div>
                    <span className={cn(
                  ...
                  <p className="text-sm text-slate-700 dark:text-slate-400 mb-4">{rec.description}</p>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-emerald-pro-600/10">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-slate-700 dark:text-slate-400">AI-generated recommendation</span>
                    </div>
                    {rec.actionable && (
