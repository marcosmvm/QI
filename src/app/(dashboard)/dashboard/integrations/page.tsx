      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        {categories.map((category) => {
          ...
          return (
            ...
            >
              <p className="text-sm text-slate-700 dark:text-slate-400">{category.name}</p>
...
function IntegrationCard({ integration }: { integration: Integration }) {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          >
            <Icon
              className={`h-5 w-5 ${
                integration.connected ? "text-emerald-pro-400" : "text-slate-700 dark:text-slate-400"
              }`}
            />
          </div>
          <div>
      ...
      <p className="text-sm text-slate-700 dark:text-slate-400 mb-4">{integration.description}</p>
      ...
      <div className="flex items-center gap-2">
        {integration.connected ? (
          <>
            ...
            <button className="flex items-center gap-2 px-3 py-1.5 text-sm text-slate-700 dark:text-slate-400 border border-border-default dark:border-graphite rounded-lg hover:bg-light-bg-secondary dark:bg-midnight-blue/50 transition-colors">
