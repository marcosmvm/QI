  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-8">
        ...
        <p className="text-slate-900 dark:text-slate-200 mt-1">Meeting scheduling and calendar management</p>
      </motion.div>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-3 gap-6">
            ...
            <div className="col-span-2 glass-premium p-6">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 rounded-lg border border-emerald-pro-600/20 text-slate-900 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white hover:bg-emerald-pro-600/10 transition-all"
                  >
                    <ChevronLeft className="h-4 w-4" />
                  </button>
                  <button
                    onClick={() => setCurrentDate(new Date(2026, 0, 20))}
                    className="px-3 py-2 rounded-lg border border-emerald-pro-600/20 text-sm text-slate-900 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white hover:bg-emerald-pro-600/10 transition-all"
                  >
                    Today
                  </button>
                  <button
              ...
              <div className="grid grid-cols-7 gap-2 mb-2">
                {weekDays.map((day) => (
                  <div key={day} className="text-center text-xs font-semibold text-slate-900 dark:text-slate-200 uppercase tracking-wider py-2">
                    {day}
                  </div>
                ))}
              </div>
                ...
                {calendarDays.map((day, index) => {
                  ...
                  return (
                    ...
                    >
                      <span className={cn(
                        "text-sm font-medium",
                        day.currentMonth ? "text-slate-900 dark:text-white" : "text-slate-900 dark:text-slate-200",
                      ...
                      {appointments.length > 0 && (
                        <div className="mt-1 space-y-1">
                          ...
                          {appointments.length > 2 && (
                            <div className="text-[10px] text-slate-900 dark:text-slate-200 px-1">
              ...
              <div className="glass-premium p-5">
                ...
                {selectedDateAppointments.length === 0 ? (
                  <div className="text-center py-8">
                    <Calendar className="h-12 w-12 text-slate-900 dark:text-slate-200/30 mx-auto mb-3" />
                    <p className="text-sm text-slate-900 dark:text-slate-200">No appointments scheduled</p>
                    <Button
                      size="sm"
                        ...
                        >
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-slate-900 dark:text-slate-200">{apt.duration}</p>
                              </div>
                            </div>
                            <span className={cn(
                          ...
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <div>
                              ...
                              <p className="text-[10px] text-slate-900 dark:text-slate-200">{apt.lead.company}</p>
                            </div>
                          </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-slate-900 dark:text-slate-200">{apt.date} • {apt.time}</p>
                        </div>
                      </div>
                    );
                  })}
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-emerald-pro-600/10">
                    <th className="text-left text-xs font-semibold text-slate-900 dark:text-slate-200 uppercase tracking-wider px-6 py-4">Meeting</th>
                    <th className="text-left text-xs font-semibold text-slate-900 dark:text-slate-200 uppercase tracking-wider px-4 py-4">Lead</th>
                    <th className="text-left text-xs font-semibold text-slate-900 dark:text-slate-200 uppercase tracking-wider px-4 py-4">Date & Time</th>
                    <th className="text-left text-xs font-semibold text-slate-900 dark:text-slate-200 uppercase tracking-wider px-4 py-4">Type</th>
                    ...
                    return (
                      <tr key={apt.id} className="hover:bg-emerald-pro-600/5 transition-colors">
                        <td className="px-6 py-4">
                          ...
                          <p className="text-xs text-slate-900 dark:text-slate-200 mt-0.5">{apt.duration}</p>
                        </td>
                        <td className="px-4 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-900 dark:text-slate-200">{apt.lead.company}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-4 py-4">
                          <p className="text-sm text-slate-900 dark:text-white">{apt.date}</p>
                          <p className="text-xs text-slate-900 dark:text-slate-200">{apt.time}</p>
                        </td>
                        <td className="px-4 py-4">
                          <div className="flex items-center gap-2">
                            <TypeIcon className="h-4 w-4 text-slate-900 dark:text-slate-200" />
