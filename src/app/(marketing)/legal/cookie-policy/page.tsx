        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-sora font-bold text-light-text dark:text-white mb-6">
              <span className="gradient-text-cyan-violet headline-underline">Cookie Policy</span>
            </h1>
      ...
      <SectionWrapper variant="default">
        <Container size="md">
          <div className="prose prose-lg prose-invert max-w-none">
            <h2 className="text-2xl font-sora font-bold text-light-text dark:text-white mb-4">What Are Cookies</h2>
            ...
            <h2 className="text-2xl font-sora font-bold text-light-text dark:text-white mb-4">Types of Cookies We Use</h2>

            <h3 className="text-xl font-sora font-semibold text-light-text dark:text-white mb-3">Essential Cookies</h3>
            <p className="text-light-text-secondary dark:text-silver mb-4">
              Required for the website to function. These cannot be disabled.
            </p>

            <h3 className="text-xl font-sora font-semibold text-light-text dark:text-white mb-3">Analytics Cookies</h3>
            <p className="text-light-text-secondary dark:text-silver mb-4">
              Help us understand how visitors interact with our website through tools like Google Analytics.
            </p>

            <h3 className="text-xl font-sora font-semibold text-light-text dark:text-white mb-3">Marketing Cookies</h3>
            <p className="text-light-text-secondary dark:text-silver mb-6">
              Used to deliver relevant advertisements and track campaign performance.
            </p>

            <h2 className="text-2xl font-sora font-bold text-light-text dark:text-white mb-4">Managing Cookies</h2>
            <p className="text-light-text-secondary dark:text-silver mb-6">
              You can control cookies through your browser settings. Note that disabling certain cookies may affect website functionality.
            </p>

            <h2 className="text-2xl font-sora font-bold text-light-text dark:text-white mb-4">Third-Party Cookies</h2>
            <p className="text-light-text-secondary dark:text-silver mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-light-text dark:text-white mb-4">Contact</h2>
            <p className="text-light-text-secondary dark:text-silver">
