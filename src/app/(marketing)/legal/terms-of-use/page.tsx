        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-sora font-bold text-slate-900 dark:text-white mb-6">
              <span className="text-gradient headline-underline">Terms of Use</span>
            </h1>
      ...
      <SectionWrapper variant="default">
        <Container size="md">
          <div className="prose prose-lg prose-invert max-w-none">
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">2. Description of Services</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">3. User Responsibilities</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-4">You agree to:</p>
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">4. Intellectual Property</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">5. Payment Terms</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">6. Limitation of Liability</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">7. Termination</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">8. Changes to Terms</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">9. Contact</h2>
            <p className="text-slate-700 dark:text-slate-200">
