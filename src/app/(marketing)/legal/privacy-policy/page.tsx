      ...
      <SectionWrapper variant="default">
        <Container size="md">
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <p className="text-slate-900 dark:text-slate-200 mb-4">We collect information in several ways:</p>
            <ul className="text-slate-900 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <p className="text-slate-900 dark:text-slate-200 mb-4">We use your information to:</p>
            <ul className="text-slate-900 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <p className="text-slate-900 dark:text-slate-200 mb-4">You have the right to:</p>
            <ul className="text-slate-900 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <p className="text-slate-900 dark:text-slate-200 mb-4">For EU prospects and data subjects, we:</p>
            <ul className="text-slate-900 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <p className="text-slate-900 dark:text-slate-200 mb-4">For California residents, we:</p>
            <ul className="text-slate-900 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
