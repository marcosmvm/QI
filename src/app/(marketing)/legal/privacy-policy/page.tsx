        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-sora font-bold text-slate-900 dark:text-white mb-6">
              <span className="text-gradient headline-underline">Privacy Policy</span>
            </h1>
      ...
      <SectionWrapper variant="default">
        <Container size="md">
          <div className="prose prose-lg prose-invert max-w-none">
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">1. Information We Collect</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-4">We collect information in several ways:</p>
            <ul className="text-slate-700 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">2. How We Use Your Information</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-4">We use your information to:</p>
            <ul className="text-slate-700 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">3. Data Sharing</h2>
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">4. Data Security</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">5. Your Rights</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-4">You have the right to:</p>
            <ul className="text-slate-700 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">6. Cookies</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
              We use cookies and similar technologies to improve your experience. See our Cookie Policy for more details.
            </p>

            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">7. GDPR Compliance (EU)</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-4">For EU prospects and data subjects, we:</p>
            <ul className="text-slate-700 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">8. CCPA Compliance (California)</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-4">For California residents, we:</p>
            <ul className="text-slate-700 dark:text-slate-200 mb-6 list-disc pl-6 space-y-2">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">9. International Transfers</h2>
            <p className="text-slate-700 dark:text-slate-200 mb-6">
            ...
            <h2 className="text-2xl font-sora font-bold text-slate-900 dark:text-white mb-4">10. Contact Us</h2>
            <p className="text-slate-700 dark:text-slate-200">
