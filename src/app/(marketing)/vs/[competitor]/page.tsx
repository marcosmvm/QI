    ...
    <>
      ...
      <section className="relative py-32 overflow-hidden bg-white dark:bg-deep-space">
        ...
        <Container className="relative z-10">
          <Link
            href="/vs"
            className="inline-flex items-center gap-2 text-slate-900 dark:text-slate-300 hover:text-emerald-pro-600 transition-colors mb-8"
          >
          ...
          >
            ...
            <p className="text-xl text-slate-900 dark:text-slate-300 mb-8">{data.description}</p>

            <div className="flex flex-wrap gap-4 text-sm text-slate-900 dark:text-slate-300">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-light-bg-secondary dark:bg-midnight-blue">
                  ...
                  <th className="px-6 py-4 text-center text-sm font-medium text-slate-900 dark:text-slate-300">
                    {data.name}
                  </th>
                </tr>
              </thead>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      {feature.quantum ? (
                        ...
                        <X className="h-5 w-5 text-slate-900 dark:text-slate-300 mx-auto" />
                      )}
                    </td>
                    <td className="px-6 py-4 text-center">
                      {feature.competitor ? (
                        <Check className="h-5 w-5 text-slate-900 dark:text-slate-300 mx-auto" />
                      ) : (
                        <X className="h-5 w-5 text-slate-900 dark:text-slate-300/50 mx-auto" />
                      )}
                    </td>
                  </tr>
                ))}
            ...
            {data.advantages.map((advantage, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-slate-900 dark:text-slate-300">{advantage.description}</p>
                </motion.div>
              );
            })}
          </div>
      ...
      <SectionWrapper variant="default">
        <Container size="md">
          ...
          >
            ...
            <p className="text-slate-900 dark:text-slate-300 mb-6">{data.pricingNote}</p>
