      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <p className="text-xl text-slate-900 dark:text-slate-200 mb-10">
              {study.subtitle}
            </p>
        ...
        <Container size="md">
          <div className="space-y-16">
            ...
            >
              ...
              <p className="text-lg text-slate-900 dark:text-slate-200 leading-relaxed">
                {study.challenge}
              </p>
            </motion.div>
            ...
            {study.metrics.map((metric, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-slate-900 dark:text-slate-200">{metric.label}</p>
                </div>
              </motion.div>
            ))}
          </div>
