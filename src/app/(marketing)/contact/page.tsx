          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-900 dark:text-slate-200">{contactInfo.address}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 feature-grid-item">
                ...
                <ul className="space-y-3 text-slate-900 dark:text-slate-200 text-sm">
              ...
              <div className="p-8 rounded-3xl border border-border-default dark:border-graphite bg-light-bg-secondary dark:bg-midnight-blue">
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <p className="text-center text-slate-900 dark:text-slate-200 text-sm">
