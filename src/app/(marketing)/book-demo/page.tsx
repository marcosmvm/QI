            ...
            >
                ...
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-900 dark:text-slate-200">{testimonial.role}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="flex items-center gap-4 pt-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-900 dark:text-slate-200">No spam, ever</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-emerald-pro-400" />
                  <span className="text-sm text-slate-900 dark:text-slate-200">Free consultation</span>
                </div>
              </div>
            </motion.div>
              ...
              <div className="p-8 rounded-3xl border border-border-default dark:border-graphite bg-light-bg-secondary dark:bg-midnight-blue/50">
                ...
                {step === "calendar" && (
                  <div className="space-y-6">
                    ...
                    {selectedDate && (
                      <div>
                        <p className="text-sm text-slate-900 dark:text-slate-200 mb-3">
                          Available times for{" "}
