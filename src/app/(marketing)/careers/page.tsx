            ...
            >
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-slate-900 dark:text-slate-200 text-sm">AI Engines</p>
                </div>
                <div className="text-center">
                  <p className="text-4xl font-sora font-bold text-emerald-pro-500">LA</p>
                  <p className="text-slate-900 dark:text-slate-200 text-sm">Based</p>
                </div>
                <div className="text-center">
                  <p className="text-4xl font-sora font-bold text-emerald-pro-400">2024</p>
                  <p className="text-slate-900 dark:text-slate-200 text-sm">Founded</p>
                </div>
                <div className="text-center">
                  <p className="text-4xl font-sora font-bold text-energy-orange">Remote</p>
                  <p className="text-slate-900 dark:text-slate-200 text-sm">First</p>
                </div>
              </div>
            </motion.div>
          </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-4 mt-2">
                          <span className="flex items-center gap-1 text-slate-900 dark:text-slate-200 text-sm">
