...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${sora.variable} ${inter.variable} ${figtree.variable} antialiased bg-light-bg dark:bg-deep-space text-slate-900 dark:text-white min-h-screen transition-colors duration-200`}>
        {children}
        <SpeedInsights />
      </body>
    </html>
