      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex items-center gap-8 pt-4">
            <div>
              <p className="text-3xl font-sora font-bold text-white">95%+</p>
              <p className="text-sm text-steel">Deliverability Rate</p>
            </div>
            <div>
              <p className="text-3xl font-sora font-bold text-white">3x</p>
