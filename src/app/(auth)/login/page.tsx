        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex items-center gap-8 pt-4">
            <div>
              ...
              <p className="text-sm text-slate-900 dark:text-slate-300">Deliverability Rate</p>
            </div>
            <div>
              <p className="text-3xl font-sora font-bold text-slate-900 dark:text-white">3x</p>
              <p className="text-sm text-slate-900 dark:text-slate-300">Reply Rate Increase</p>
            </div>
            <div>
              <p className="text-3xl font-sora font-bold text-slate-900 dark:text-white">24/7</p>
              <p className="text-sm text-slate-900 dark:text-slate-300">Support Available</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-card p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-900 dark:text-slate-300">Sign in to access your dashboard</p>
            </div>
